...
@Entity
@Table(name = "cpu_test_result", catalog = "appcloud_performance")
public class CpuTestResult implements java.io.Serializable{
	...
	/** default constructor */
	public CpuTestResult() {
	}

	/** minimal constructor */
	public CpuTestResult(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public CpuTestResult(Integer id, Integer vmId, Timestamp testTime,

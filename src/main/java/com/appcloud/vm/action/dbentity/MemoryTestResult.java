...
@Entity
@Table(name = "memory_test_result", catalog = "appcloud_performance")
public class MemoryTestResult implements java.io.Serializable{
	...
	/** minimal constructor */
	public MemoryTestResult(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public MemoryTestResult(Integer id, Integer vmId, Timestamp testTime, float transferSpeed, float totalTime,Integer totalEvent, float totalEventTime,

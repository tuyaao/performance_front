...
@Entity
@Table(name = "oltp_test_result_week", catalog = "appcloud_performance")
public class OltpTestResultWeek implements java.io.Serializable{
	...
	/** default constructor */
	public OltpTestResultWeek() {
	}

	/** minimal constructor */
	public OltpTestResultWeek(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public OltpTestResultWeek(Integer id, Integer vmId, Timestamp testTime, float transactionFrq,
			float deadLockFrq,float readWriteFrq,float otherOperationFrq, float totalTime,Long totalEvent,

...
<div id="container">
	...
	<div id="inner">
		<s:include value="../template/_left.jsp?menu=bycompany"></s:include>
		<div class="right">
				...
				<tbody>
					...
					<tr>
						...
						<td class="leftalign padding5">
							<input type="checkbox" value="4" name="companyselect" >
							<label>阿里云-北京</label>
							<input type="checkbox" value="5" name="companyselect" >
							<label>阿里云-青岛</label>
							<input type="checkbox" value="6" name="companyselect" >
							<label>Ucloud</label>
							<input type="checkbox" value="3" name="companyselect" >
							<label>华为</label>
							<input type="checkbox" value="2" name="companyselect" >
							<label>云海</label><br/>
							<input type="checkbox" value="8" name="companyselect" >
							<label>青云</label>
							<input type="checkbox" value="7" name="companyselect" >
							<label>盛大云</label>
							<input type="checkbox" value="9" name="companyselect" >
							<label>亚马逊</label>
							<input type="checkbox" value="10" name="companyselect" >
							<label>腾讯云</label>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td></td>
						<td></td>
						<td><button class="button" onclick="confirm('compare/getcompanyaction')">确定</button></td>
					</tr>
					</tbody>
			</table>
...
function clickSetting(obj){
	...
	$("#setting button:even").attr("name","noselect");
	$("#setting button:odd").attr("name","noselect");
	$(obj).removeClass("graybutton").addClass("button");
	$(obj).attr("name","configureselect");
	console.log('odd '+$("#setting button:odd").attr("name"));
	console.log('even '+$("#setting button:even").attr("name"));
}
